...
import { WeatherFunctionType, IconFunctionType } from '../types/index';

const getIcon: IconFunctionType = (icon) => {
...
const getWeather: WeatherFunctionType = async (attrs, options) => {
